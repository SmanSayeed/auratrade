      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-8 text-center lg:text-left">
          <div className="w-full lg:w-1/2 flex flex-col justify-center lg:justify-start">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-center lg:text-left leading-[1.2] text-brand-black dark:text-white mb-3">
              Committed To <span className="gold-gradient-text">Your Success</span>
            </h2>
            <p className="text-gray-500 dark:text-gray-400 text-sm md:text-base font-medium mb-6">
            ...
            <button className="mt-6 bg-brand-black dark:bg-brand-light text-white dark:text-brand-black px-8 md:px-12 py-4 md:py-5 rounded-xl font-extrabold text-sm uppercase tracking-wider transition-all hover:brightness-110 active:scale-95 shadow-lg shadow-black/5 dark:shadow-white/5">
              Contact Support
            </button>
          </div>
