...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-brand-light dark:bg-brand-black pt-12 pb-6 border-t border-brand-black/5 dark:border-brand-border">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-10">
          ...
          <div className="col-span-1 lg:col-span-2 text-center lg:text-left">
            <h4 className="font-bold text-brand-black dark:text-white mb-4 text-sm uppercase tracking-wider">Services</h4>
          ...
          <div className="col-span-1 lg:col-span-2 text-center lg:text-left">
            <h4 className="font-bold text-brand-black dark:text-white mb-4 text-sm uppercase tracking-wider">Support</h4>
            <ul className="space-y-4 text-[13px] font-medium text-gray-500">
          ...
          <div className="col-span-1 lg:col-span-2 text-center lg:text-left">
            <h4 className="font-bold text-brand-black dark:text-white mb-4 text-sm uppercase tracking-wider">Company</h4>
            <ul className="space-y-4 text-[13px] font-medium text-gray-500">
          ...
          <div className="col-span-1 lg:col-span-2 text-center lg:text-left">
            <h4 className="font-bold text-brand-black dark:text-white mb-4 text-sm uppercase tracking-wider">Legal</h4>
            <ul className="space-y-4 text-[13px] font-medium text-gray-500">
        ...
        <div className="pt-6 border-t border-brand-black/5 dark:border-brand-border text-center">
          <p className="text-[10px] text-gray-500 mb-4 font-bold uppercase tracking-widest">Secured By SSL. Copyright © AuraTrade. All rights reserved. 2026</p>
